...
router.register(r'upcoming-events', views.UpcomingEventViewSet, basename="upcomingevent")
...
router.register(r'timeline_monthly', views.MonthlyTimelineViewSet, basename="monthlytimeline")
